...
window.GC_STRINGS.de = {
  ...
  "queue.live.typical": "Gestern: ~{n} Min.",
  "queue.live.typicalCapped": "Gestern: {n} Std.+",
  "queue.typicalAge": "von gestern",
  ...
  "queue.aheadQuestionAgain": "Wie viele sind jetzt noch vor dir?",
  "queue.aheadAria": "Personen vor dir in dieser Warteschlange",
  "queue.ahead.value": "~{n}",
  "queue.ahead.200": "200+",
  "queue.aheadSkip": "Weiß nicht / überspringen",
  "queue.detailsQuestion": "Wie bewegt sich diese Schlange?",
  "queue.detailsHelp": "Optional — tipp an, was du inzwischen erkennen kannst, dann auf „Fertig“.",
  ...
  "queue.joinedSuccess": "Timer gestartet. Alles Weitere ist freiwillig.",
  ...
  "today.hereLabel": "In deiner Halle",
  "today.nearestLabel": "Am nächsten",
  "today.longestLabel": "Längste Schlange übrig",
  "today.hereIn": "Du bist in Halle {hall}",
  "today.hereChange": "ändern",
  "today.hereQuestion": "Wo bist du?",
  "today.hereElsewhere": "Woanders",
  "today.hereAria": "Sag dem Guide, in welcher Halle du bist",
  "today.hereSetAria": "Ich bin in Halle {hall}",
  ...
  "map.reportSubject": "gamescom guide: Stand-Meldung — Halle {hall}, Stand {nr}",
  "map.reportBody":
    "Stand {nr} in Halle {hall}\n{link}\n\nDer Guide zeigt hier aktuell: {shown}\n\nWer oder was tatsächlich dort steht:\n",
  "map.reportShownNone": "noch nichts",
  ...
  "map.here": "Ich bin hier",
  "map.hereOn": "Du bist hier",
  "map.hereAria": "Halle {hall} als deinen Standort setzen",
  "map.hereOnAria": "Du bist in Halle {hall} — tippe, um das zu erneuern",
  "map.chipHereAria": ", du bist hier",
