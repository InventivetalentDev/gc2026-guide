...
SITE="_headers css data fonts icons index.html js manifest.webmanifest map.html sw.js"
...
NOT_SITE=".git .github .gitignore .wrangler CNAME README.md LICENSE dist docs tools wrangler.toml"
