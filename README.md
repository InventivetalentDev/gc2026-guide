...
| File | Contents |
|---|---|
| `data/exhibitors.json` | Array of exhibitors: location, games, tags, crowd forecast. `type: "trade"` cards are business-area booths and carry `offers` and an `access` value instead of a lineup and a queue index |
